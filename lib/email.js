    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Welcome to APi Pangeran - an awesome REST API!</h3>
            <p>
...
If you have any problem, please contact via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=6285934362661">WhatsApp</a></span></span>
      ...
      let mailOptions = {
        from: '"KokoPangeran" <no-reply@gmail.com>',
        to: email,
        subject: `Verify Email - APi Pangeran`,
        html: inboxGmail,
      };
